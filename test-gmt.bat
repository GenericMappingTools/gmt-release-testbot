...
echo "gmt begin" > globe_batch.bat
echo "gmt coast -Rg -JG%%MOVIE_FRAME%%/20/%%MOVIE_WIDTH%% -Gmaroon -Sturquoise -Bg -X0 -Y0" >> globe_batch.bat
echo "gmt end" >> globe_batch.bat
gmt movie globe_batch.bat -Nglobe_batch -T12 -Fmp4 -Agif -C6ix6ix100 -Lf -Vd
